...
class SklearnModel(_base_model.BaseModel, abc.ABC):
    """
    Parent class based on :obj:`~easyPheno.model._base_model.BaseModel` for all models with a sklearn-like API to share
    functionalities. See :obj:`~easyPheno.model._base_model.BaseModel` for more information.
