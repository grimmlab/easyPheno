...
class TemplateTorchModel(_torch_model.TorchModel):
    ...
    Steps you have to do to add your own model:
        ...
        5. Define the hyperparameters and ranges you want to use for optimization in *define_hyperparams_to_tune()*.
            | CAUTION: some are already defined in :obj:`~easypheno.model._torch_model.TorchModel.common_hyperparams()`
            | and suggested in :obj:`~easypheno.model._torch_model.TorchModel.__init__.py`. You can directly use them here.
