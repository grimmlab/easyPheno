...
class TemplateTensorflowModel(_tensorflow_model.TensorflowModel):
    ...
    Steps you have to do to add your own model:
        ...
        5. Define the hyperparameters and ranges you want to use for optimization in *define_hyperparams_to_tune()*.
            | CAUTION: some are already defined in :obj:`~easypheno.model._tensorflow_model.TensorflowModel.common_hyperparams()`, which you can directly use here.
            | Some of them are already suggested in :obj:`~easypheno.model.tensorflow_model.TensorflowModel`.
